...
<body>
    ...
    <form name='myForm' method="post" action="update_rec_cnf.php" onSubmit="return chk()" > 
	<table align="center" border="2">
		<tr>
			...
			<td>
<input type="text" name="name" id="name" onBlur="ajaxFunction()" size="50" width="55" value="<?php echo $cname;?>" >
			</td>
			<td align="right">
				Today Date : 
			</td>
		...
		<tr>
			...
			<td>
<input type="text" name="mob" id="mob" onBlur="ajaxFunction2()" value="<?php echo $mob;?>">
			</td>
			<td align="right">
				Voucher Number  : 
			</td>
			<Td>
				<input type="text" name="vnum1" value="<?php echo $vnum;?>" disabled="disabled">
			</Td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="email" id="email" onBlur="ajaxFunction3()" value="<?php echo $email;?>">
			</td>
			<td align="right">
				Reciever Name : 
			</td>
		...
		<tr>
			...
			<td>
				<input type="text" name="tin" id="tin" value="<?php echo $tin;?>">
			</td>
				...
				<table align="center" border="2">
					<tr>
						<td colspan="8" align="center">
							<h2>Purchased Products [ Updatable ] </h2>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p1" id="p1" size="36" maxlength="20" value="<?php echo $p1;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q1" id="q1" size="8" value="<?php echo $q1;?>">
						</td>	
						<td>
							<input type="text" name="pp1" id="pp1" size="8" onBlur="pone()" value="<?php echo $pp1;?>">
						</td>	
						<td>
							<input type="text" name="t1" id="t1" size="12" value="<?php echo $t1;?>">
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p2" id="p2" size="36" maxlength="20" value="<?php echo $p2;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q2" size="8" id="q2"  value="<?php echo $q2;?>">
						</td>	
						<td>
							<input type="text" name="pp2" size="8" onBlur="ptwo()" id="pp2"  value="<?php echo $pp2;?>">
						</td>	
						<td>
							<input type="text" name="t2" size="12" id="t2"  value="<?php echo $t2;?>">
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p3" id="p3" size="36" maxlength="20"  value="<?php echo $p3;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q3" id="q3" size="8"  value="<?php echo $q3;?>">
						</td>	
						<td>
							<input type="text" name="pp3"  id="pp3" size="8" onBlur="pthree()"  value="<?php echo $pp3;?>">
						</td>	
						<td>
							<input type="text" name="t3" size="12" id="t3"  value="<?php echo $t3;?>" >
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p4" size="36" id="p4" maxlength="20"  value="<?php echo $p4;?>">
						</td>	
						<!--<td>
						...
						<td>
							<input type="text" name="q4" size="8" id="q4"  value="<?php echo $q4;?>">
						</td>	
						<td>
							<input type="text" name="pp4" size="8" id="pp4" onBlur="pfour()"  value="<?php echo $pp4;?>" >
						</td>	
						<td>
							<input type="text" name="t4" size="12" id="t4"  value="<?php echo $t4;?>" >
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p5" size="36" id="p5" maxlength="20"  value="<?php echo $p5;?>">
						</td>	
						<!--<td>
						...
						<td>
							<input type="text" name="q5" size="8" id="q5"  value="<?php echo $q5;?>">
						</td>	
						<td>
							<input type="text" name="pp5" size="8" id="pp5" onBlur="pfive()"  value="<?php echo $pp5;?>"> 
						</td>	
						<td>
							<input type="text" name="t5" size="12" id="t5"  value="<?php echo $t5;?>" >
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p6" size="36" id="p6" maxlength="20"  value="<?php echo $p6;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q6" size="8" id="q6"  value="<?php echo $q6;?>">
						</td>	
						<td>
							<input type="text" name="pp6" size="8" id="pp6" onBlur="psix()"  value="<?php echo $pp6;?>">
						</td>	
						<td>
							<input type="text" name="t6" size="12" id="t6" value="<?php echo $t6;?>">
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p7" size="36" id="p7" maxlength="20" value="<?php echo $p7;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q7" size="8" id="q7" value="<?php echo $q7;?>">
						</td>	
						<td>
							<input type="text" name="pp7" size="8" id="pp7" onBlur="pseven()" value="<?php echo $pp7;?>">
						</td>	
						<td>
							<input type="text" name="t7" size="12" id="t7" value="<?php echo $t7;?>">
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p8" size="36" id="p8" maxlength="20" value="<?php echo $p8;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q8" size="8" id="q8" value="<?php echo $q8;?>">
						</td>	
						<td>
							<input type="text" name="pp8" size="8" id="pp8" onBlur="peight()" value="<?php echo $pp8;?>">
						</td>	
						<td>
							<input type="text" name="t8" size="12" id="t8" value="<?php echo $t8;?>">
						</td>	
					</tr>	
					...
					<tr>
						...
						<td>
							<input type="text" name="p9" size="36" id="p9" maxlength="20" value="<?php echo $p9;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q9" size="8" id="q9" value="<?php echo $q9;?>">
						</td>	
						<td>
							<input type="text" name="pp9" size="8" id="pp9" onBlur="pnine()" value="<?php echo $pp9;?>">
						</td>	
						<td>
							<input type="text" name="t9" size="12" id="t9" value="<?php echo $t9;?>">
						</td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="p10" size="36" id="p10" maxlength="20" value="<?php echo $p10;?>">
						</td>
						<!--<td>
						...
						<td>
							<input type="text" name="q10" size="8" id="q10" value="<?php echo $q10;?>">
						</td>	
						<td>
							<input type="text" name="pp10" size="8" id="pp10" onBlur="pten()" value="<?php echo $pp10;?>">
						</td>	
						<td>
							<input type="text" name="t10" size="12" id="t10" value="<?php echo $t10;?>">
						</td>	
					</tr>	
...
<?php echo $e2;?>
						...
						<td align="right">
							...
							<br>
							<strong>Transportation Charges :</strong> <input type="text" name="cour" id="cour" size="8" onBlur="test()" value="<?php echo $cour;?>">
							<br>
							<!--<strong>Discount ( RS ) :</strong> <input type="text" name="dis" id="dis" size="8" value="0">
							<br>-->
							<strong>Vat ( 4 % ) :</strong> <input type="text" name="vat" size="8" id="vat" onBlur="myvat()" value="<?php echo $e4;?>">
							<br>
							<strong>Tax ( 1 % ):</strong> <input type="text" name="tax" size="8" id="tax" onBlur="mytax()" value="<?php echo $tax;?>">
							<br>
							...
							<br>
							<hr>
							<strong>Grand Total  :</strong> <input type="text" name="gtot" size="10" id="gtot" value="<?php echo $e1;?>">
							</td>
						</tr>
					</table>
			</td>
		...
		<tr>
			<td colspan="4" align="center">
				<input type="submit" name="Updaate" value="Update">
