...
{
	$tin = $_POST['tin'];
	$tin_tax ="Tax Invoice           Client Tin Number :";
}
...
$qr = "Insert into master_data values ('','$a1','$a2','$month','$a3','$a4','$a5','$a6','$a7','$tin','$a8','$a9','$a10','$a11','$a12','$a13','$a14','$a15','$a16','$a17','$a18','$a19','$a20','$a21','$a22','$a23','$a24','$a25','$a26','$a27','$a28','$a29','$a30','$a31','$a32','$a33','$a34','$a35','$a36','$a37','$a38','$a39','$a40','$a41','$a42','$a43','$a44','$a45','$a46','$a47','$a48','$a49','$a50','$a51','$b1','$b2','$b3','$b4','$b5','$b6','$b7','$b8','$b9','$b10','$e5','$e2','$e3','$e4')";
...
echo "P1 Len : ".strlen($a9);
echo "<br>";
echo "P2 Len : ".strlen($a13);
echo "<br>";
echo "P3 Len : ".strlen($a17);
/*
while ( strlen($a1) < 35)
{
	$a1 = $a1 . "  ";
...
$pr2 = strlen($a13);
$p2pad = $clen - $pr2;
$a13 = str_pad($a13,$p2pad);
echo "P2 pad :".$p2pad;
echo "<br>";

$pr3 = strlen($a17);
$p3pad = $clen - $pr3;
$a17 = str_pad($a17,$p3pad);
echo "P3 pad :".$p3pad;
echo "<br>";
