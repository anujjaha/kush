...
//			$this->Cell( 0, 9, 'Krishna  Multi Print Pvt Ltd.', 1, 1, 'C' );
	...
	$fpdf->MultiCell( 0, 6, "   Date :" .  $_GET['date']."         User Name : ". $_GET['user'] ."          Order Form No : " .  $_GET['f_num']  , 0, 1 );
	...
	$fpdf->Write( 6,
		     "      Party Name :  ". $_GET['data'] . "                                         Mobile Number  : " . $_GET['mob']."\n\n       Address :  " .  $_GET['add'] . "          Machine Name :  " . $_GET['m_name'] ."\n\n" . "               ". $_GET['j_name'] ."                                                                                  ". $_GET['c_size']."\n\n               ". $_GET['p_name'] . "                                                        " . $_GET['tot_shet'] ."\n\n                    ". $_GET['print_det'] . "                                                                         ". $_GET['p_by']."\n\n                   ". $_GET['lami_det'] . "                                                                \n\n\n\n\n  "      . $_GET['more']) ;
