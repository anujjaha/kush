...
<script type="text/javascript">
	...
	/*
		...
		var gtot;
		gtot = (parseInt(t1) + parseInt(t2) + parseInt(t3) + parseInt(t4) + parseInt(t5) + parseInt(t6) + parseInt(t7) + parseInt(t8) + parseInt(t9) + parseInt(t10));
	//	alert(gtot);
		var vat = document.getElementById("vat").value;
		var vat_tax = (parseInt(gtot) * parseInt(vat) / 100);
	//	alert(vat_tax);
		document.getElementById("gtot").value = parseInt(gtot) + parseInt(vat_tax);
		*/
		var mtot = document.getElementById("mtot").value;
		var tax = (parseInt(mtot) * 1 / 100);
//		alert (tax);
	...
	function mytax()
	{
		...
		var set_tax = (parseInt(gtot) * parseInt(tax) / 100);
//		alert(set_tax);
		document.getElementById("gtot").value = parseInt(gtot) + parseInt(set_tax);
...
//		alert(a);
		...
		*/
		...
		document.getElementById("gtot").value =parseInt(gtot);
...
//	 alert("test");
		...
		t10 = document.getElementById("t10").value;
		var mtot;
		mtot = (parseInt(t1) + parseInt(t2) + parseInt(t3) + parseInt(t4) + parseInt(t5) + parseInt(t6) + parseInt(t7) + parseInt(t8) + parseInt(t9) + parseInt(t10));
	//	alert(gtot);
	...
	function test()
	{
		var mtot = document.getElementById("mtot").value;
//		alert (mtot);
		var vat_tax = (parseInt(mtot) * 4 / 100);
//		alert (vat_tax);
...
function fone()
{
	...
	var fz1 = parseInt(f1) * parseInt(z1);
	document.getElementById("q1").value = parseInt(fz1);
}
function ftwo()
{
	var f2 = document.getElementById("s2").value;
	var z2 = document.getElementById("j2").value;
	var fz2 = parseInt(f2) * parseInt(z2);
...
function fthree()
{
	...
	var fz3 = parseInt(f3) * parseInt(z3);
...
function ffour()
{
	...
	var fz4 = parseInt(f4) * parseInt(z4);
...
function ffive()
{
	...
	var fz5 = parseInt(f5) * parseInt(z5);
...
function fsix()
{
	...
	var fz6 = parseInt(f6) * parseInt(z6);
...
function fsevent()
{
	...
	var fz7 = parseInt(f7) * parseInt(z7);
...
function feight()
{
	...
	var fz8 = parseInt(f8) * parseInt(z8);
...
function fnine()
{
	...
	var fz9 = parseInt(f9) * parseInt(z9);
...
function ften()
{
	...
	var fz10 = parseInt(f10) * parseInt(z10);
...
<input type="text" name="mob" id="mob" onBlur="ajaxFunction2()">
		...
		<tr>
			...
			<td>
				<input type="text" name="email" id="email" onBlur="ajaxFunction3()">
			</td>
			<td align="right">
				Reciever Name : 
			</td>
			...
			<!-- Inner Table Column Start -->
				<table align="center" border="2">
					...
					<tr>
						...
						<td>
							<input type="text" name="p1" id="p1" size="36" maxlength="13">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p2" id="p2" size="36" maxlength="13">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p3" id="p3" size="36" maxlength="13">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p4" size="36" id="p4" maxlength="13">
						</td>	
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p5" size="36" id="p5" maxlength="13">
						</td>	
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p6" size="36" id="p6" maxlength="13">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p7" size="36" id="p7" maxlength="13">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p8" size="36" id="p8" maxlength="13">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p9" size="36" id="p9" maxlength="13">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p10" size="36" id="p10" maxlength="13">
						</td>
						<td>
...
<textarea name="msg" rows="6" cols="65">
						...
						<td align="right">
							...
							<strong>Adjustment ( Round off Amount ):</strong> <input type="text" name="ra" size="8" id="ra" onBlur="myra()" value="0">
							<br>
							<hr>
