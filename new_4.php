			...
			<!-- Inner Table Column Start -->
				<table align="center" border="2">
					...
					<tr>
						...
						<td>
							<input type="text" name="p1" id="p1" size="36" maxlength="20">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p2" id="p2" size="36" maxlength="20">
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="p3" id="p3" size="36" maxlength="20">
						</td>
						<td>
